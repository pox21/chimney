...
;// CONCATENATED MODULE: ./src/js/plugins/fslightbox.js
...
var mobileMenuDeactive = function mobileMenuDeactive(selector) {
...
;// CONCATENATED MODULE: ./src/js/modules/themes.js
var themeCheckbox = document.querySelector('.themes__input');
var colorBg = getComputedStyle(document.documentElement).getPropertyValue("--color-bg");
var colorText = getComputedStyle(document.documentElement).getPropertyValue("--color-black");
